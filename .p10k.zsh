# Generated by Powerlevel10k configuration wizard on 2024-11-02 at 22:06 CET.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 49619.
# Wizard options: powerline, rainbow, unicode, 24h time, angled separators,
# blurred heads, blurred tails, 2 lines, dotted, right frame, lightest-ornaments,
# sparse, fluent, transient_prompt, instant_prompt=quiet.
